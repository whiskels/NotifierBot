...
public class DebtInMemoryLoader extends InMemoryDataLoader<Debt> implements TelegramLabeled {
    ...
    public DebtInMemoryLoader(@Value("${external.customer.debt.url}") String jsonUrl,
