...
public class EmployeeDataLoaderAndProvider extends InMemoryJsonDataLoaderAndProvider<Employee> implements TelegramLabeled {
    ...
    public EmployeeDataLoaderAndProvider(@Value("${external.employee.url}") String jsonUrl) {
        super(jsonUrl);
    }
