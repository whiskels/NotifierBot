...
class ScheduleAddHandlerTest extends AbstractHandlerTest {
    ...
    private static final String EXPECTED_AUTH_VALID_COMMAND = format("Scheduled status messages to be sent daily at *10:00*");
    private static final String EXPECTED_AUTH_INVALID_COMMAND = format("You've entered invalid time%n" +
            "Please try again");

    @Autowired
    private CommandHandler scheduleAddHandler;
